...
public class ViewBoletosPendentes extends javax.swing.JFrame {
    ...
    public ViewBoletosPendentes(PessoaDTO pessoa) throws SQLException {
        this.pessoa = pessoa;
        initComponents();
    ...
    public void carregarBoletos(PessoaDTO pessoa) throws SQLException{
        List<BoletoDTO> listaBoleto = this.service.buscarBoleto(pessoa);
        ...
        listaBoleto.forEach(item -> {
            rowData[0] = item.getDtVencimento();
